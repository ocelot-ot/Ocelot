...
/// <summary>
/// Base class for polling options that derive the polling interval from service discovery provider configuration.
/// Checks the file configuration first, then the internal configuration; falls back to <see cref="DelayMilliseconds"/>.
/// </summary>
